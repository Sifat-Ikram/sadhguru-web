...
import guru from "./assets/Black_and_White_Illustrative_Smart_Brain_Technology_Logo_1.png";
    ...
    <div className="min-h-screen flex items-center flex-col py-5 space-y-14 bg-gradient-to-b from-white to-[#65b5bb80]">
      ...
      <div className="flex flex-col items-center space-y-5">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-base sm:text-xl md:text-3xl font-medium uppercase text-[#196469] text-center">
            Mental Counselling AI
          </h1>
          <p className="text-xs sm:text-sm md:text-base font-semibold text-center text-[#196469]">
            Need mental advice or guidance?
          </p>
          <p className="text-xs sm:text-sm md:text-base font-semibold text-center text-[#196469]">
      ...
      {callState === "idle" && (
        <button
          onClick={handleCall}
          className="w-[13rem] sm:w-[15rem] md:w-[17rem] lg:w-[19rem] rounded-[14px] bg-[#196469] hover:bg-[#165c5e] flex justify-center items-center gap-2 md:gap-3 lg:gap-4 p-3 transition-all duration-300 ease-in-out"
        >
          <FaPhoneVolume className="text-white md:text-xl" />
          <span className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-medium uppercase">
            Call for support
          </span>
        </button>
      )}
